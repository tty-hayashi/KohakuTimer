...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Timer.st', // list all sources in dependency order
                    'src/Timer-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-timer',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'Timer', /* add other code-to-test packages here */
                    'SUnit',
                    'Timer-Tests' /* add other test packages here */
                ],
